...
def get_gnews_news():
    ...
    url = f"https://gnews.io/api/v4/search?q=\"детский спорт научные факты"\" OR \"детское дзюдо полезные советы"\" OR \"детское футбол полезные советы"\" OR \"детская художественная гимнастика полезные советы"\" OR \"детская мотивация в спорте научные факты"\" OR \"правильное питание для детей занимающихся спортом\" OR \"детская психология спорта\"&lang=ru&max=10&apikey=fa8bb60f8111d5d43d7b8e4b957aceed"
    try:
