...
def get_gnews_news():
    ...
    url = f"https://gnews.io/api/v4/search?q=спорт OR дзюдо OR футбол OR гимнастика OR мотивация OR \"правильное питание\" OR \"психология спорта\"&lang=ru&max=10&apikey=fa8bb60f8111d5d43d7b8e4b957aceed"
    try:
